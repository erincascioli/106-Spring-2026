...
{
    /// <summary>
    /// STRUCT (Value type) that represents a Rectangle in 2D space.
    /// </summary>
    internal struct RectangleStruct
    {
        ...
        public RectangleStruct(float x, float y, float width, float height)
        {
            this.x = x;
            this.y = y;
            this.width = width;
        ...
        public static float operator +(RectangleStruct r1, RectangleStruct r2)
        {
